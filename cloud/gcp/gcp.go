...
func NewGcpCloud(ctx context.Context, projectID string, creds string) (*GcpCloud, error) {
	if ctx == nil {
...
func (c *GcpCloud) GetOdysseyUbuntuAMIID() (string, error) {
